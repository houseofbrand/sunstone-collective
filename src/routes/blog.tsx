...
export const Route = createFileRoute("/blog")({
  ...
  head: () => ({
    meta: [
      { title: "OEM Sunglasses Journal — Guides for Brands & Buyers | SunglassManufacturer.com" },
      {
        name: "description",
        content:
          "Insights and guides on OEM sunglasses manufacturing, private label branding, wholesale buying, custom logo printing and launching your own eyewear brand.",
      },
    ...
    <>
      ...
      <header className="container-luxe pt-8 pb-14 max-w-3xl">
        ...
        <h1 className="font-display text-4xl md:text-5xl mt-3">
          Guides for eyewear brands & buyers.
        </h1>
