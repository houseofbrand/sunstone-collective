...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact SunglassManufacturer.com | OEM & Private Label Enquiries" },
      {
        name: "description",
        content:
          "Contact SunglassManufacturer.com for OEM, private-label, wholesale and sourcing enquiries.",
      },
      { property: "og:title", content: "Contact SunglassManufacturer.com" },
      {
        property: "og:description",
        content: "OEM, private label & wholesale sunglasses inquiries.",
      },
    ...
    <>
      ...
      <header className="container-luxe pt-8 pb-14 max-w-3xl">
        ...
        <p className="mt-6 text-muted-foreground">
          Reach us on WhatsApp for the fastest response, or submit a detailed inquiry and our team
          will respond within one working day.
        </p>
      </header>
      <section className="container-luxe pb-24 grid md:grid-cols-3 gap-6">
        <a
          href={waLink("Hello, I'd like to discuss OEM sunglasses.")}
          target="_blank"
          rel="noreferrer"
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-2">
            For OEM, private label and export queries
          </p>
        </a>
        <div className="border border-border p-8 bg-card">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            For Indian and international B2B enquiries
          </p>
        </div>
      </section>
      <section className="container-luxe pb-24 text-center">
        <button
          onClick={() => openCatalogRequest({ category: "Sunglasses", source: "contact_page" })}
