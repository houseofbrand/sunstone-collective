...
export const blogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      "Pricing depends on the product, material, lens, quantity, branding and packaging brief. The displayed starting MOQ is 120 pieces for suitable private-label programmes; custom OEM development may require a higher quantity.",
  ...
  },
  {
    ...
    body: [
      ...
      "## Private Label",
      "You choose from an existing range of frames and add your branding — logo on temples, suitable lens options and branded packaging. The displayed starting MOQ is 120 pieces for suitable private-label programmes.",
      "## White Label",
