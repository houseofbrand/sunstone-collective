...
export const blogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      "Pricing depends on the product, material, lens, quantity, branding and packaging brief. Low MOQ starts from 12 pcs for applicable designs; custom OEM developments may require a different MOQ.",
  ...
  },
  {
    ...
    body: [
      ...
      "## Private Label",
      "You choose from an existing range of frames and add your branding — logo on temples, suitable lens options and branded packaging. Low MOQ starts from 12 pcs for applicable designs.",
      "## White Label",
